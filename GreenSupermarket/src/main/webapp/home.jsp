...
<body>
    <%
        List<InventoryItem> products = InventoryDAO.getInventoryItems();
    ...
    <div id="hero-image">
        <img src="assets/images/Backsplash.jpg">

        <div class="welcome-text">
            <p>
                Your  destination  for  quality  produce and
        ...
        <div class="search-container">
            ...
            <div class="search-icon">
                <img src="assets/icons/bxs-search-alt-2.svg" alt="Search">
            </div>
        </div>
    </div>

    
    <h1 style="text-align: center; margin-top: 2%;">Product Catalog</h1>
